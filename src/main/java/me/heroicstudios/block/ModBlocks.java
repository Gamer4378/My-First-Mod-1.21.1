package me.heroicstudios.block;

import me.heroicstudios.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_DEEPSLATE_ORE = registerBlock("pink_garnet_deepslate_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(3, 6), AbstractBlock.Settings.create().strength(4f)
                    .requiresTool().sounds(BlockSoundGroup.DEEPSLATE)));


    // ✅ Registers both block and block item
    ...
    // ✅ Adds ALL blocks to the creative tab
